...
Here are the binaries for [Windows](http://factom.org/downloads/factom.msi), [Mac](http://factom.org/downloads/factom.mpkg.zip), and [Linux(Debian Linux)](http://factom.org/downloads/factom.deb).
